...
function Albasta() {
  ...
  useEffect(() => {
    fetch("https://api.api-onepiece.com/episodes") 
      .then((res) => res.json())
      .then((data) => {
        const splitepisode = data.slice(62, 135);
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center">
        ...
        <h3 className="cursor-pointer relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-orange-500 rounded-xl group w-96" onClick={toggleAccordion}>
...
<span class="relative w-full  text-white transition-colors duration-200 ease-in-out group-hover:text-white text-center ">Albasta</span>
        </h3>
        </div>
